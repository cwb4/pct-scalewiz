...
class ReportExporter(tk.Toplevel):
    ...
    def build(self, project):
        ...
        comp_lbl = tk.Label(details_container, text="Customer:", anchor='w')
        sample_lbl = tk.Label(details_container, text="Sample point:", anchor='w')
        cust_lbl = tk.Label(details_container, text="Production company:", anchor='w')
        ...
        bicarb_adj_lbl = tk.Label(details_container, text="Bicarbonates increased to (mg/L):", anchor='w')
        ...
        for i, trial in enumerate(self.results_queue['result_titles']):
            ...
            ent.grid(row=i, column=1, pady=1)
            ent.set(clarities[0])
